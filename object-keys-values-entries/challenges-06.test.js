...
const hasChildrenValues = (arr, character) => {
    ...
    let childIndex = names.indexOf(character);
    console.log((Object.values(characters[childIndex].children).length));
      if ((Object.values(characters[childIndex].children).length) === 0) {
          return false
      } else {
          return true
      }
...
const hasChildrenEntries = (arr, character) => {
    ...
    let childIndex = names.indexOf(character);
      if ((Object.entries(characters[childIndex].children).length) === 0) {
          return false
      } else {
          return true
      }
